...
def listar_favoritos(request):
    ...
    try:
        ...
        data = [{"id": car.id, "brand": car.brand, "model": car.model, "year": car.year, "image_url_1": car.image_url, "is_for_rent": car.is_for_rent, "is_for_sale":car.is_for_sale} for car in favoritos]
